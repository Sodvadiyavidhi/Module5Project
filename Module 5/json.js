...
function initMap() {
  //latitudes and longitudes of the map
 ...
 .then(function(response){ 
  ...
  .then(function weirdthings(jsonObj){
        ...
        let section = document.querySelector('section');
                ...
                //appending all the elements to section element.
...
//storing type of the connection
var type = connection.effectiveType;
//event listener that helps know any change in the connection.
connection.addEventListener('change', updateConnectionStatus);
function updateConnectionStatus() {
    let foot= document.querySelector('footer');
    let para=document.querySelector('p');
    sentence="Connection type is converted from" + type + " to " + connection.effectiveType;
